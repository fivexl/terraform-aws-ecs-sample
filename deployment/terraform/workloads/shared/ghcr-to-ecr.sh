...
IMAGES=(
  "ghcr.io/fivexl/n-example-voting-app-result:after result:v0.25"
  "ghcr.io/fivexl/n-example-voting-app-worker:latest worker:v0.25"
  "ghcr.io/fivexl/n-example-voting-app-vote:after vote:v0.25"
)
